...
namespace MiniE_Commerce.Persistence.Migrations
{
    ...
    [Migration("20240116022150_updatetypeuserıd")]
    partial class updatetypeuserıd
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiniE_Commerce.Domain.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 1, 16, 5, 21, 49, 868, DateTimeKind.Local).AddTicks(7586),
                            IsDeleted = false,
                            Name = "BaseCategory"
                        });
                });
            ...
            modelBuilder.Entity("MiniE_Commerce.Domain.Entities.OrderDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MiniE_Commerce.Domain.Entities.OrderDetails", b =>
                {
                    b.HasOne("MiniE_Commerce.Domain.Entities.Order", "Order")
